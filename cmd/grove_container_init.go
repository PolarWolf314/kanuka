...
var groveContainerInitCmd = &cobra.Command{
	...
	Long: `Initialize container support by adding container configuration to devenv.nix
and creating default container profiles in kanuka.toml.

This enables you to build OCI containers from your Grove development environment
using 'kanuka grove container build'.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		GroveLogger.Debugf("Adding container profiles to kanuka.toml")
		...
		GroveLogger.Infof("Container profiles added to kanuka.toml")
