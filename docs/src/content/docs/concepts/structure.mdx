---
title: Where Kanuka Stores Your Files
description: An explanation for the project structure and file organization.
---

Kanuka creates different files depending on which features you're using. Understanding where everything goes helps you work effectively with the tool.

## Project files

Kanuka stores all project-related files in a `.kanuka` folder at the root of your project:
...
- .env.kanuka your secrets, encrypted by Kanuka
- **.kanuka**
...
Kanuka stores user files in two locations:
...
Each project you're registered with has its own key pair. Kanuka automatically
